...
function generateCityMap(cityType) {
...
function addCityTypeControl(cityType) {
...
addCityTypeControl('forest');
addCityTypeControl('mountain');
addCityTypeControl('lake');
addCityTypeControl('city');

// Event listener for city type selection
document.getElementById('city-type').addEventListener('change', event => {
  generateCityMap(event.target.value);
});

// Generate initial city map
generateCityMap('forest');
