...
def visualize_map(terrain, roads, buildings, forests, filename="generated_map.jpg"):
    ...
    # Outlining roads for clarity
    ax.contour(roads, colors='black', linewidths=0.5, levels=[0.5, 1])
    
    # Outlining buildings for clarity
    ax.contour(buildings, colors='black', linewidths=0.5, levels=[1, 2, 3])
